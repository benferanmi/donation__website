  ...
  return (
    <div className='donationmenu'>
        ...
        <div className='donationmenu__button'>
            <Link to='/dashboard' className='dashboard-link' id='Dashboard'>
                <label for="Dashboard" className='donationmenu__button1'>  < FaDashcube className='mr-10' /> Dashboard</label>
            </Link>
        </div>
        <div className='donationmenu__button'>
            <Link to='/donationlist' id='donationlist' className='dashboard-link'>
        ...
        <div className='donationmenu2'>
            <p> < FiHelpCircle className='mr-10' /> Get help </p>
            <p> < FiSettings className='mr-10' /> Setting </p>
        </div>
    </div>
  )
}
